...
//TAUX prev
localStorage.setItem("HypRev2", 5.6);
...
var mntdeduct =AssVie;
		...
		{document.getElementById('edi').innerHTML = '100 000 TND';}*/
		...
		else		
	 	{
            ...
            var impotduMAxi = (outRevenuMaxi-0)*0+0;
        }
        else if (outRevenuMaxi>=5000 && outRevenuMaxi<20000){
            var impotduMAxi = (outRevenuMaxi-5000)*0.26+0;
        }
        else if (outRevenuMaxi>=20000 && outRevenuMaxi<30000){
            var impotduMAxi = (outRevenuMaxi-20000)*0.28+3900;
        }
        else if (outRevenuMaxi>=30000 && outRevenuMaxi<50000){
            var impotduMAxi = (outRevenuMaxi-30000)*0.32+6700;
        }
        else if (outRevenuMaxi>=50000){
            var impotduMAxi = (outRevenuMaxi-50000)*0.35+13100;
        }
 ...
 var GainImpotAnOptMaxi = impotdu-impotduMAxi;
        ...
        if (outRevenuMax>=0 && outRevenuMax<5000){
            var impotduMAx = (outRevenuMax-0)*0+0;
        }
        else if (outRevenuMax>=5000 && outRevenuMax<20000){
            var impotduMAx = (outRevenuMax-5000)*0.26+0;
        }
        else if (outRevenuMax>=20000 && outRevenuMax<30000){
            var impotduMAx = (outRevenuMax-20000)*0.28+3900;
        }
        else if (outRevenuMax>=30000 && outRevenuMax<50000){
            var impotduMAx = (outRevenuMax-30000)*0.32+6700;
        }
        else if (outRevenuMax>=50000){
            var impotduMAx = (outRevenuMax-50000)*0.35+13100;
        }
        if(isNaN(impotduMAx)){
            impotduMAx = 0;
        }
